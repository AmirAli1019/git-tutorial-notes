...
1. **[Diffing and Patching](./1-diffing-and-patching.md)** - Learn how to compare changes and create patches
2. **[Basic Git Commands](./2-basic-git-commands.md)** - Essential commands for everyday Git usage
3. **[Restoring Commits](./3-restoring-commits.md)** - Undo changes and restore previous commits
4. **[Merging and Branching](./4-merging-and-branching.md)** - Manage multiple branches and merge workflows
...
1. Start with [Basic Git Commands](./2-basic-git-commands.md) if you're new to Git
